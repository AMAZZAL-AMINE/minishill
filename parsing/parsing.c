...
/*   Updated: 2023/07/30 21:22:00 by mamazzal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_and_split(t_minishell *minishell, char *token, int pos)
{
	...
	get_cmd_ = get_cmd_with_fixes_size(token, \
		commande_length(token));
	...
	minishell->parsing[pos].args = \
		init_and_split_utilis_part1(minishell, dst, pos);
